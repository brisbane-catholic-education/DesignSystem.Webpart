    ...
    return (
      <div className={styles.designPatternMessageBar + ' ms-Grid'} >
        <div className="ms-Grid-row bce-design-system-row">
          ...
          <DefaultButton className="bce-design-system-buttom" href="https://github.com/brisbane-catholic-education/DesignSystem.Webpart/tree/master/src/webparts/designPatternsMessageBar" target="_blank" >
          ...
          <DefaultButton className="bce-design-system-buttom" href="https://developer.microsoft.com/en-us/fabric#/controls/web/messagebar" target="_blank" >
