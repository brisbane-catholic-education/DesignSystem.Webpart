    ...
    return (
      <div className={styles.designPatternsDropdown + ' ms-Grid'} >
        <div className="ms-Grid-row bce-design-system-row">
          ...
          <DefaultButton className="bce-design-system-buttom"  href="https://developer.microsoft.com/en-us/fabric#/controls/web/dropdown" target="_blank" title="BCE Github - Dropdown">
