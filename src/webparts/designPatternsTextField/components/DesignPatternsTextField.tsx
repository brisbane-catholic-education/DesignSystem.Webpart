      ...
      <div className={styles.designPatternsTextField + ' ms-Grid'} >
        <div className="ms-Grid-row bce-design-system-row">
          ...
          lines of text. The text displays on the screen in a simple, uniform format. </p>
            <DefaultButton className="bce-design-system-buttom" href="https://github.com/brisbane-catholic-education/DesignSystem.Webpart/tree/master/src/webparts/designPatternsTextField" target="_blank">
            ...
            <DefaultButton className="bce-design-system-buttom" href="https://developer.microsoft.com/en-us/fabric#/controls/web/textfield" target="_blank">
