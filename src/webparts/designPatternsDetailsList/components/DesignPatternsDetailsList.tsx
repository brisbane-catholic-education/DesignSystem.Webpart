...
export default class DesignPatternsDetailsList extends React.Component<
  IDesignPatternsDetailsListWebPartProps,
  {}
> {
  ...
  private _ensureStateMatrix() {
    setTimeout(() => {
      const cells = document.querySelectorAll(
        ".stateMatrix .ms-DetailsList .ms-List-cell"
      );
      if (cells.length > 0) {
        const cell3 = cells[3].querySelector(
          ".ms-DetailsRow-cellCheck"
        ) as HTMLElement;
        cell3.click();
        const cell4 = cells[4].querySelector(
          ".ms-DetailsRow-cellCheck"
        ) as HTMLElement;
        cell4.click();
      }
  ...
  private _randomFileIcon(): { docType: string; url: string } {
    const docType: string = this.FILE_ICONS[
      Math.floor(Math.random() * this.FILE_ICONS.length)
    ].name;
    return {
      docType,
  ...
  private _lorem(wordCount: number): string {
    const startIndex =
      this.loremIndex + wordCount > this.LOREM_IPSUM.length
        ? 0
        : this.loremIndex;
      ...
      <div className={styles.designPatternsDetailsList + " ms-Grid"}>
        <div className="ms-Grid-row bce-design-system-row">
          ...
          <p className="bce-design-system-p-l">
            DetailsList is a derivative of the List component. It is a robust
            way to display an information rich collection of items. It can
            support powerful ways to aid a user in finding content with sorting,
        ...
        <div className="ms-Grid-row bce-design-system-row">
          <div className="bce-design-system-box">
            <span className="bce-design-system-subsectionTitle bce-design-system-border-bottom">
              DetailsList sample
            </span>
            <DetailsList
              items={this._items}
            ...
            <br />
            <br />
            <span className="bce-design-system-sectionTitle bce-design-system-border-bottom">
              State matrix
            </span>
        ...
        <div className="ms-Grid-row bce-design-system-row">
          ...
          <p>
            Use them to display content, not to display commands or settings.
          </p>
          <p>Only provide useful columns of metadata. </p>
          <p>
